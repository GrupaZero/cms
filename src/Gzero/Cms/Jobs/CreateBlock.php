...
class CreateBlock {
     ...
     * @return CreateBlock
     */
    public static function menu(string $title, Language $language, User $author, array $attributes = [])
    {
        return new self($title, $language, $author, array_merge($attributes, ['type' => 'menu']));
    }
